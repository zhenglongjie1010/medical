            ...
            loginIn(params)
                .then(res => {
                    ...
                    if(res.code ==1 ){
                        ...
                        _this.$store.commit('setPatientId',res.patientMsg.id);
                        _this.$store.commit('setName',res.patientMsg.name);
                        _this.$store.commit('setPicture',res.patientMsg.picture);
                        console.log(res.patientMsg.picture)
                        setTimeout(function(){
